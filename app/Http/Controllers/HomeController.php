...
class HomeController extends Controller
{
	...
	public function get() {
    	...
    	$summonerArray = array(37033230,40440021,21674598,23783981,70182000,71941260,21174748,28995620);

    	for($sum = 0; $sum < count($summonerArray); $sum++) {

		$matchlist = $matchlistApi->matchlist($summonerArray[$sum], "RANKED_SOLO_5x5", "PRESEASON2016");
